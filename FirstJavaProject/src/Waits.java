...
// so to target any specific element or locator explicit wait is used 
		...
		// there is class webdriverwait used for explicit wiat for we need create obj for that class and sends two arguments 1) driver obj it needs to know on which driver obj it should participate action 2) time how many seconds it should wait
	...
	public static void addItems(WebDriver driver,String[]  productneeded) {
		...
		for(int i =0;i< options.size();i++) 
			...
			List productneedelist = Arrays.asList(productneeded);  
