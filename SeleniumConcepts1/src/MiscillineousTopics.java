...
//		}
		...
		for(int i =0;i< options.size();i++) 
			...
			List<String> productneedelist = Arrays.asList(productneeded);  // converting array to array list because arraylist contains less space that too converting during run time and it consists of "contains" using which we can retract the data easily
